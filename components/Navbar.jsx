    ...
    <>
      ...
      <div className="sticky top-0 z-50 bg-white shadow-sm border-b border-gray-200">
        <div className="relative">
          ...
          <div
            ref={dropdownRef}
            className={`absolute left-0 w-full bg-white shadow-lg transition-all duration-300 ease-out ${activeDropdown !== null ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2 pointer-events-none'}`}
